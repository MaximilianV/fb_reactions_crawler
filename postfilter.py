...
def parse_arguments():
    ...
    parser.add_argument('-t, --reaction-gap', dest='top_reaction_min_gap', action='store', default=10, type=int, metavar='top_reaction_min_gap', help='Filter posts where the dominant isnt X percent higher then the secondary reaction.')
...
def post_is_useful(post):
    ...
    reactions = post.reactions.remove('like').values()
